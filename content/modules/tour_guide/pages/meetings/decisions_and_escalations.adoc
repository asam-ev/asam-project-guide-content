...
Should a project member not submit their vote during the project group meeting, this member shall be considered absent without excuse for the meeting. The overall validity of the vote may be affected, see <<v_valid,voting is only valid if>>. 

Also refer to xref:tour_guide:meetings/guidelines.adoc#_inactive_project_member[inactive project members].
...
**Note that certain subgroup decisions require an escalation to a project voting. See xref:tour_guide:meetings/decisions_and_escalations.adoc#from_subgroup_to_project_group[].**
