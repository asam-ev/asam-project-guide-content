...
If a project wishes to change its scope or timeline or requires a change to budget it should submit to the TSC for a decision. Prior to submitting to the TSC, project consensus on the request being submitted is required. See the xref:compendium:Projects/02_project_types.adoc#[TSC Guidelines] for guidance on submission. In some cases the TSC may explicitly request presentation of specific material, decisions this shall be communicated clearly beforehand by the OR. A project is required to submit a controlling report to each TSC in accordance with the submission deadlines.
