...
A template is provided by ASAM for the respective tool.

The tool for writing meeting minutes is to be defined by the project during its kickoff. +
For questions please contact the project lead.

The designated xref:tour_guide:meetings/guidelines.adoc#_minute_taker[minute taker] is responsible for taking the minutes using this template.

The minutes shall document all important decisions (including votes).
