...
:page-progress_bar: progress_bar_simple-meeting_notes.svg
:tour_guide_small:
...
Meeting notes (minutes) are to be taken in the project's GitLab or SharePoint.
The appropriate place in each case contains a template for meeting notes that shall be used.
The designated xref:tour_guide:meetings/guidelines.adoc#_minute_taker[minute taker] is responsible for taking the notes.
