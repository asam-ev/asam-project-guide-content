...
=== Polls and voting
These are covered in xref:tour_guide:meetings/decisions_and_escalations.adoc#_guidelines_for_formal_voting[].

=== Inactive project member
TODO: For definition of project member, see PROJECT STUCTURE
