...
=== Polls and voting
These are covered in xref:tour_guide:page$meetings/decisions_and_escalations.adoc#_guidelines_for_formal_voting[guidelines for formal voting].

=== Inactive project member

An inactive xref:compendium:Projects/01_project_terms.adoc#project-member[project member] is a project member who has been absent, without informing the meeting initiator beforehand, from two consecutive project group and/or subgroup meetings.
