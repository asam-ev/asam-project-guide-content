...
Formal voting is only possible in a project group meeting. See xref:tour_guide:page$meetings/decisions_and_escalations.adoc##_guidelines_for_formal_voting[]
