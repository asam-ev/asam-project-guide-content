...
[horizontal]
<<Technical Steering Committtee (TSC) meetings>>:: Coordination within ASAM between multiple projects as well as the with the organization itself
...
The tasks and processes of the ASAM TSC are documented in the he https://www.asam.net/active-projects/resources/#[TSC Guidelines^].
...
These meetings are recommended to be held in person (face to face). This must be clearly communicated in the meeting agenda and made available sufficiently in advance to allow for travel organisation.

ASAM requires project meetings to take place at least every 4 months. 
ASAM recommends project group meetings take place at least every two months. 

If it is taking place live or online, formal voting is only possible in a project group meeting as a formal vote requires involvement of all enrolled companies.
