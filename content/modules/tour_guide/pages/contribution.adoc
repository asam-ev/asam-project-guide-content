...
== Overview 
Developing content for ASAM standards is focused around the concept of xref:contribution/contribute_with_issues.adoc[contributing with issues]. +
...
. Review implementation progress of issue with {role-sg-lead} and the other {role-project-participant} in Subgroup meetings
