...
NOTE: Parts of the contribution process rely on project infrastructure being in place
(pipelines, repositories, file storage). Before starting work, verify your project has
completed the steps in xref:tools.adoc#infrastructure-pipelines[Infrastructure & Pipelines for Projects].
