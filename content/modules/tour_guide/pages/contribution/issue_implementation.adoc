...
These tags use https://semver.org/lang/de/[semantic versioning^].
...
These comments work identically to those described in xref:contribution/contribute_with_issues.adoc#_discuss_issues["discuss issues"]
