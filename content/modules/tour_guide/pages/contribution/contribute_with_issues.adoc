...
== Reopen issues
If the topics addressed in a closed issue become relevant again, an issue may be reopened. If the issue was created before the current project, its state is set to NEW in the contribution workflow.
