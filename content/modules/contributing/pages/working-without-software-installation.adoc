...
{remote-xref}[Remote Repositories] provide an integrated working environment and text editor with which users can directly create and edit files without having to install xref:compendium:Tools/git.adoc[] or an editor like xref:compendium:Tools/vscode.adoc[]. +
