...
Each user may choose their own favorite setup as long as it is compatible with the xref:main.adoc[Default Online Setup]. +
...
include::contributing:partial$list-of-tools.adoc[tag=recommended]
