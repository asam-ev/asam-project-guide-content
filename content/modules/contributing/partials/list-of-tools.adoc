...
|{teams-icon-norole} +
xref:compendium:Tools/teams-and-sharepoint.adoc[]
...
Relevant for users that want to discuss and chat about information that do not fit into the project's repositories.
|{mandatory}
|ASAM IT infrastructure
