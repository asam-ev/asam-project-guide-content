...
// Internal links
:basic-tooling-xref: xref:contributing:
...
//--Tool icons--
:remote-icon: image:contributing:remote.png[alt="Remote Repository Icon", title="Remote Repository Page", width={icon-width-large},role=right]
:github-icon: {github-url}[image:contributing:github-icon.png[alt="GitHub Icon", title="Github Page", width={icon-width-large},role=right] ,window=_blank]
:gitlab-icon: {gitlab-url}[image:contributing:gitlab-icon.png[alt="GitLab Icon", title="GitLab Page", width={icon-width-large},role=right] ,window=_blank]
...
//--Tool page icons--
:remote-icon-page: {remote-xref}[image:contributing:remote.png[alt="Remote Repository Icon", title={return-info}, width={icon-width-medium},role=right]]
:github-icon-page: {remote-xref}[image:contributing:github-icon.png[alt="GitHub Icon", title={return-info}, width={icon-width-medium},role=right]]
:gitlab-icon-page: {remote-xref}[image:contributing:gitlab-icon.png[alt="GitLab Icon", title={return-info}, width={icon-width-medium},role=right]]
...
:remote-icon-norole: {remote-xref}[image:contributing:remote.png[alt="Remote Repository Icon", width={icon-width-small}]]
:github-icon-norole: {remote-xref}[image:contributing:github-icon.png[alt="GitHub Icon",width={icon-width-small}]]
:gitlab-icon-norole: {remote-xref}[image:contributing:gitlab-icon.png[alt="GitLab Icon", width={icon-width-small}]]
