...
include::compendium:page$How-Tos/how-to__write_a_feature.adoc[{offset-value}]

include::compendium:page$How-Tos/how-to__review_code.adoc[{offset-value}]

include::compendium:page$How-Tos/how-to__merge.adoc[{offset-value}]