...
Whether or not you prefer to work online or with locally installed software, you must do a minimum setup before you can participate in and contribute to any project. +
