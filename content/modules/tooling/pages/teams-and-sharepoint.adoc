...
IMPORTANT: Project files such as chapters, specifications, or images intended for use in the standard are to be handled through GitLab instead! See xref:compendium:Guidelines/workflow__trunk.adoc[] for more information.
