...
include::compendium:page$Guidelines/asciidoc__graphics.adoc[tag=drawio]
...
include::compendium:page$How-Tos/how-to__change_asset_library_content.adoc[leveloffset=+1]