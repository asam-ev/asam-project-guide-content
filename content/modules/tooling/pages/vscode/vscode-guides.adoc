...
include::compendium:page$tools/vscode/vscode__recommended_vscode_extensions.adoc[{offset-value-sub}]

include::compendium:page$tools/vscode/vscode__recommended_vscode_settings.adoc[{offset-value}]