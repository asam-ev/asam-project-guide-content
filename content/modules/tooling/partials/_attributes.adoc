...
:remote-icon: image:tooling:remote.svg[alt="Remote Repository Icon", width={icon-width-large},role=right]
:remote-icon-norole: image:tooling:remote.svg[alt="Remote Repository Icon", width={icon-width-small}]
