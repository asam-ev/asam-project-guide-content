...
One example is that there is no need to install any software to be able to participate.
...
If you have any questions or feedback, do not hesitate to contact the xref:compendium:Concepts/roles-overview.adoc[ASAM Office Responsible (OR)].
