...
== Concept
include::compendium:page$Terminology/project-type-concept.adoc[tag=summary]

For more details, see xref:compendium:Terminology/project-type-concept.adoc[] in the Compendium.
...
+
--
include::compendium:page$Terminology/project-type-standard.adoc[tag=new-summary]
--
Major Version Update::
+
--
include::compendium:page$Terminology/project-type-standard.adoc[tag=major-summary]
--
Minor Version Update::
+
--
include::compendium:page$Terminology/project-type-standard.adoc[tag=minor-summary]
--
Revision::
+
--
include::compendium:page$Terminology/project-type-standard.adoc[tag=revision-summary]
--
====

include::compendium:page$Terminology/project-type-standard.adoc[tag=summary]

For more details, see xref:compendium:Terminology/project-type-standard.adoc[] in the Compendium.

== Study
include::compendium:page$Terminology/project-type-study.adoc[tag=summary]

For more details, see xref:compendium:Terminology/project-type-study.adoc[] in the Compendium.



// == Implementation
// include::compendium:page$Terminology/project-type-implementation.adoc[tag=summary]

// For more details, see xref:compendium:Terminology/project-type-implementation.adoc[] in the Compendium.
