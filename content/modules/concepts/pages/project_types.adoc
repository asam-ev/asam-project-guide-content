...
__{asam}__ defines three project types, which further characterize the work to be done within the projects.
They are:
...
image::project_types_overview.drawio.svg[title="ASAM project types overview"]
