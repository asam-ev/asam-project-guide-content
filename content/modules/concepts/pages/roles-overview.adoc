...
h|xref:role-specific:wg-member.adoc[(2) Project Participant]
...
h|xref:role-specific:project-lead.adoc[(3) Project Lead]
...
h|xref:role-specific:wg-lead.adoc[(4) Working Group Lead]
...
h|xref:role-specific:gtm.adoc[(5) Global Technology Manager (GTM)]
...
h|xref:role-specific:technical-writer.adoc[(6) Technical Writer]
...
h|xref:role-specific:tsc.adoc[(7) Technical Steering Committee (TSC)]
