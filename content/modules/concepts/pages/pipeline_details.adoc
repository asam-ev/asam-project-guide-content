...
* https://en.wikipedia.org/wiki/Lint_(software)[Linting^] and testing documents for rules defined in the xref:compendium:Editorial_guide.adoc[] and returning found errors
