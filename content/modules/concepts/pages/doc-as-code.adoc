...
Specific ASAM writing styles and rules can be found in the xref:compendium:writing_guidelines/editorial_guide.adoc[**Editorial Guide**].
...
image::issue_example.png[title=Example for a topic discussion through the GitLab issue board in a project]
