...
* https://en.wikipedia.org/wiki/Lint_(software)[Linting^] and testing documents for rules defined in the xref:latest@asamprojectguide:compendium:Editorial_guide.adoc[editorial guide] and returning found errors
