...
* They typically provide online editors for content, so users can choose to participate in projects xref:contributing:working-without-software-installation.adoc[without having to install software] (besides any standard web browser)
