...
// rewrite motivation sentence
All standards in the ASAM Simulation domain follow the concept of Documentation as Code (Doc-as-Code).
This concept refers to using the same tools for documentation as for writing (software) code. +
