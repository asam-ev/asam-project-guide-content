...
image::compendium:asam/project_lifecycle-v2.svg[alt=The ASAM Project Phases, title=The ASAM Project Phases. The icons are explained in the xref:project_types.adoc[project types]]
