...
Each project consists of many different __Project Participants__ who directly contribute to the project's development.
...
|(5)
^|xref:role-specific:wg-lead.adoc[image:role-specific:roles_overview-wg_lead.svg[]]
a|A __Project Participant__ leading the activities of a Working Group. +
Many projects divide up their activities into so-called Working Groups which focus on specific aspects of a project.
Each of these groups may be led by a __Working Group Lead__.

3+<s|[.underline]#Supporting roles#
|(6)
^|xref:role-specific:gtm.adoc[image:role-specific:roles_overview-gtm.svg[]]
