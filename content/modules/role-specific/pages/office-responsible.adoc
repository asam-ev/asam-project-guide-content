...
* Strong knowledge in ASAM's tools
...
Interface to extern:::
* Contracting of service providers as outlined in project proposal
...
* Organizing of webinar for project presentation
...
* Providing working repository and pipeline for projects
