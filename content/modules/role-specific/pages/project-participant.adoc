...
Project Participants can take on additional roles, such as **xref:role-specific:project-lead.adoc[]**, **xref:role-specific:wg-lead.adoc[]**, or become a **xref:role-specific:ccb-member.adoc[]**.
