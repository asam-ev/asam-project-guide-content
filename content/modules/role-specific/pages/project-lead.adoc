...
Leading of project members, project meetings and project Sub-groups:::
* Overview of project members and Sub-groups
* Setting up meetings (weekly, Sub-groupmeetings, Sub-groups, change control board)
