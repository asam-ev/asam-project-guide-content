...
:plantuml-xref: {standard-tooling-xref}plantuml.adoc
...
:settings-image: https://cdn-icons-png.flaticon.com/512/70/70115.png
:extensions-image: https://cdn-icons-png.flaticon.com/512/3793/3793602.png

:docker-image: https://www.docker.com/wp-content/uploads/2022/03/vertical-logo-monochromatic.png
:plantuml-image: https://upload.wikimedia.org/wikipedia/commons/3/30/Plantuml_Logo.svg
...
:gitlab/gitlab-icon: {gitlab-url}[image:compendium:gitlab/gitlab-icon.png[alt="GitLab Icon", title="GitLab Page", width={icon-width-large},role=right] ,window=_blank]
...
:plantuml-icon: {plantuml-url}[image:{plantuml-image}[alt=PlantUML, title="PlantUML Page", width={icon-width-large}, role=right] ,window=_blank]
...
:gitlab/gitlab-icon-page: {remote-xref}[image:compendium:gitlab/gitlab-icon.png[alt="GitLab Icon", title={return-info}, width={icon-width-medium},role=right]]
...
:plantuml-icon-page: {plantuml-xref}[image:{plantuml-image}[alt=PlantUML, title={return-info}, width={icon-width-medium}, role=right]]
...
:gitlab-icon-norole: {remote-xref}[image:compendium:gitlab/gitlab-icon.png[alt="GitLab Icon", width={icon-width-small}]]
...
:plantuml-icon-norole: {plantuml-xref}[image:{plantuml-image}[alt=Draw.io, width={icon-width-small}]]
