...
image::openodd_deliverables.png[width=600]
...
ASAM SOVD:: API specified technology-independently, deliverables include a mapping to OpenAPI (yaml).
ASAM XIL:: API specified in a data model, two mappings included. One to python and one to C#.
