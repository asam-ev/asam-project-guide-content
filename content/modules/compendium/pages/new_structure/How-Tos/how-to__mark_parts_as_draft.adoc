...
The best approach to do this on the editor level is described under xref:compendium:new_structure/How-Tos/how-to__active_draft_section_preview.adoc[].