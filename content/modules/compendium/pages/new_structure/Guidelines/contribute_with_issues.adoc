...
TIP: If you want to contribute more directly, see xref:compendium:temp_issues/contribute_in_asciidoc.adoc[].
...
Each issue and merge/pull request must apply labels as defined in xref:compendium:temp_issues/issue_and_mr_labels.adoc[]. +
...
See xref:compendium:temp_issues/ticket_triage.adoc[] for more details.
