= How-To: Forking from repository
:description: TODO
:keywords: TODO
...
Use branches to do so (xref:compendium:How-Tos/how-to_create_branch_from_issue.adoc[] and xref:compendium:How-Tos/how-to_create_new_branch.adoc[])
...
To submit the changes you make in your fork back to the original repository, submit a xref:compendium:Guidelines/repo__merge-pull_requests.adoc[Merge/Pull Request] as normal in the main repository, making sure to select your fork.
