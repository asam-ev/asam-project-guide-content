...
* The WG Leads have all necessary project-level information to do their respective xref:compendium:How-Tos/cycle_planning_wg-level.adoc[WG-level Plannings]
