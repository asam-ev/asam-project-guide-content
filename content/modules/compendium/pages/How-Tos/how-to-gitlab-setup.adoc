= How-To: Setting Up Your GitLab Account
...
See xref:tooling:git/git-setup.adoc#_optional_ssh_key_pair[how to setup secure SSH connection] for instructions on generating and uploading the SSH keys.
