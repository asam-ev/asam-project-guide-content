...
. xref:compendium:How-Tos/how-to__forking_repo.adoc[Fork] the latest version of the https://code.asam.net/common/templates/proposal-template[**proposal template repository**^] into this subgroup.
