= How-To: Setup Project Development Repository
...
.. xref:compendium:How-Tos/how-to-forking_repo.adoc[Fork] the latest version of the https://code.asam.net/common/templates/standard-template[**standard template repository**^] into the existing subgroup for the project.
