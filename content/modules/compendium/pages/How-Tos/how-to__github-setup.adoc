= How-To: Setting Up Your GitHub Account
:description: How to setup your ASAM account.
:keywords: task,fragment,setup, github,account
...
The {gtm} will then add the account the to respective group or project.
...
. Send your account name to your GTM. +
