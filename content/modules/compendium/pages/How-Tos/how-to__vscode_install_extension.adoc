...
The AsciiDoc extension for __{vscode}__ allows for easy creation and supported editing of AsciiDoc or adoc files within VSCode.
...
+
include::compendium:page$Guidelines/vscode\__recommended_vs_code_extensions.adoc[tag=asciidoc]
