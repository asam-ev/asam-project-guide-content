...
If the layout and final look is important, you should create the HTMl output from the adoc files by using the asciidoctor docker container (configured in the xref:compendium:How-Tos/how-to__setup_standard_docker_config.adoc[standard docker-compose.yml]).
