...
== Context
In case a new project is proposed, the first step is to create an xref:compendium:ASAM/phase-02_proposal/how-to__executive_draft.adoc[Executive Draft] for internal analysis.
