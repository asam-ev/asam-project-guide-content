...
Besides xref:compendium:Concepts/project_types.adoc[different types of projects], there are seven main project phases that ASAM defines.
...
During this phase, the proposed project is announced and then presented to interested parties, who then can sign up to join the project team if it is approved by the TSC.
...
It is also the basis for the ASAM TSC, who decide if the project may continue or not. +
...
The Review phase contains of at least two review periods: one group review period and one outside review period. +
...
Both the group review and the outside review may be repeated if major changes had to be implemented based on the provided feedback.
