...
NOTE: See here for the template for a concept paper.
...
For more detail on versioning, see xref:compendium:page$Project Guidelines/standard_versioning.adoc[standard versioning].
