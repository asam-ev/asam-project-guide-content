...
Once everyone is happy with the changes, the merge request will be accepted and the changes made will be integrated with the trunk, deleting the originally merged branch and closing the request & associated issues.

Only project members with the role of "maintainer" can accept merge requests onto the trunk - these are decided on in project meetings.
