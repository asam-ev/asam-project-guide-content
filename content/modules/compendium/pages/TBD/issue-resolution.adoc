...
The issue may exist in the xref:compendium:TBD/base_standard.adoc[base standard], in xref:compendium:TBD/associated_standard.adoc[associate standards], schema files, interface definition files, model files, examples or any other supplements of the standard.
