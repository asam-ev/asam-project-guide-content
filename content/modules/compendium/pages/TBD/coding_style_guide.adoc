...
In this case you should mark your code examples as a `+[source, osc2]+` source block as described in the xref:compendium:Guidelines/asciidoc__writing_guide.adoc[].
...
TIP: For support in Visual Studio Code, see xref:compendium:Guidelines/vscode__recommended_vscode_settings.adoc#_indentations[Indentations].
...
TIP: For support in Visual Studio Code, see xref:compendium:Guidelines/vscode__recommended_vscode_settings.adoc#_automatic_removal_of_spaces_after_periods[Automatic Whitespace Removal].
...
* For more information about creating documentation with adoc-topics check out the xref:Guidelines/asciidoc__writing_guide.adoc[].
