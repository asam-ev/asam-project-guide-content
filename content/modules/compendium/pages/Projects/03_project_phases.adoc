...
Submission of the controlling report and any additional material is the responsibility of the PL, supported by the OR and the project members.
...
Any supporting material for a presentation shall be submitted by the deadline day.

.Significant changes requiring a presentation slot in a TSC meeting.
[#tab-significant-project-changes,cols="1,1,1"]
|===
.2+|Change type 2+|Additional documents to be updated and submitted
...
Failure to submit supporting material by the deadline day shall result in cancellation of the presentation slot and thus automatic rejection of any requests.
Failure to present when requested shall result in a project being frozen.
