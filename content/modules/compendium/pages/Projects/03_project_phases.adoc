...
Besides xref:compendium:Projects/project_types.adoc[different types of projects], there are five main project phases that ASAM defines.
...
The output of the proposal phase is a set of proposal documents, detailing the project's targets, participants, the budget, timeline, and other project-related information, such as the xref:compendium:Projects/project_types.adoc[type of the project]. +
...
During this phase, the project-type specific xref:compendium:Projects/deliverables.adoc[deliverables] are developed by the project participants.
...
Depending on the size of the project, other xref:compendium:Projects/roles-overview.adoc[roles] such as subgroup leads are also elected. 
...
NOTE: Download the template for a release presentation here.
