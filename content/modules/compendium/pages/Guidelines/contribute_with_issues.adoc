...
DEVELOPMENT::
//tag::development[]
The name of the issue shall follow the xref:compendium:Guidelines/branch_naming_conventions.adoc[].
//end::development[]
...
Each issue and merge/pull request must apply labels as defined in xref:compendium:Guidelines/issue_and_mr_labels.adoc[]. +
...
See xref:compendium:Guidelines/ticket_triage.adoc[] for more details.
