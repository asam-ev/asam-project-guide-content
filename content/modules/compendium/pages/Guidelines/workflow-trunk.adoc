...
IMPORTANT: Never work on the trunk directly -- always work in <<Create development branch,separate branches>>!
...
You may also want to check out ASAM's xref:labels.adoc[**list of labels**].
