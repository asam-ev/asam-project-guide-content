...
All other meetings within a project (such as Working Group meetings) have to be set up by the respective host.
...
The agenda should be shared in the invite to the meeting.
