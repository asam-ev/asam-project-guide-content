...
:description: TODO
:keywords: TODO
:navtitle: [Coordination] Meeting Guidelines
...
See xref:compendium:How-Tos/how-to__obtain_channel_email.adoc[].

> To find the list of people registered for your group or WP, see the WP signup list.
Its location is described in the xref:compendium:Guidelines/coordination__teams-channel_file-structure.adoc[Teams&Sharepoint Overview].
...
See xref:compendium:How-Tos/how-to__meetings_in_teams.adoc[].
