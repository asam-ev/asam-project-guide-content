...
However, in order for a consistent workflow and optimal use of the automation steps set up by __{asam}__, users must be familiar with the xref:compendium:Guidelines/workflow__trunk.adoc[] and <<Writing AsciiDoc Files,AsciiDoc>>.
...
Editing AsciiDoc files in a project shall be done in development or feature branches, as described in xref:compendium:Guidelines/workflow__trunk.adoc[].
...
When writing AsciiDoc files, the writers shall follow the **xref:compendium:Guidelines/editorial_guide.adoc[]**.

For a general AsciiDoc guide, see **xref:compendium:Guidelines/asciidoc_guide.adoc[]** in this Project Guide. +
