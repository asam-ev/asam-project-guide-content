...
The approach also relies on xref:compendium:Guidelines/merge-pull_requests.adoc[Merge/Pull Request] which provide better tools and options for reviews than a direct push to the trunk would.
...
You may also want to check out ASAM's xref:compendium:Guidelines/issue_and_mr_labels.adoc#_status_labels[**list of status labels**].
...
* Apply the xref:compendium:Guidelines/issue_naming_conventions.adoc[]
...
Who:: Assignee
Steps::
. Once a proposal is ready to be implemented, create a new development branch for the issue, applying the xref:compendium:Guidelines/branch_naming_conventions.adoc[**Branch Naming Conventions**]
...
. Begin submitting work via commits to the develop branch, adhering to the xref:compendium:tools/gitlab/commit_conventions.adoc[**Commit Message Conventions**]
...
.. If there is no xref:compendium:Guidelines/merge-pull_requests.adoc[Merge/Pull Request] for this branch yet, create one
...
Both tips reduce the chance for xref:compendium:Guidelines/merge_conflicts.adoc[**Merge Conflicts**].
...
. The Service Provider refines the content in the xref:compendium:Guidelines/merge-pull_requests.adoc[Merge/Pull Request]
...
* Squash commit message MUST adhere to the xref:compendium:tools/gitlab/commit_conventions.adoc[**Commit Message Conventions**]
...
* Does it have a https://medium.com/@catalinaturlea/clean-git-history-a-step-by-step-guide-eefc0ad8696d[clear commit history^] that adheres to the xref:compendium:tools/gitlab/commit_conventions.adoc[]?
