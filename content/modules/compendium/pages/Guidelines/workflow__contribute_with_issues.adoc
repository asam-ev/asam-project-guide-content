...
TIP: If you want to contribute more directly, see xref:compendium:Guidelines/workflow__contribute_in_asciidoc.adoc[].
...
DEVELOPMENT::
//tag::development[]
The name of the issue shall follow the xref:compendium:Guidelines/repo__branch_naming_conventions.adoc[].
//end::development[]
...
Each issue and merge/pull request must apply labels as defined in xref:compendium:Guidelines/repo__issue_and_mr_labels.adoc[]. +
...
See xref:compendium:Guidelines/workflow__ticket_triage.adoc[] for more details.
