...
However, in order for a consistent workflow and optimal use of the automation steps set up by __{asam}__, users must be familiar with the xref:compendium:Guidelines/workflow-trunk.adoc[] and <<Writing AsciiDoc Files,AsciiDoc>>.
