= [Workflow] Trunk-based Remote Repositories
...
== Workflow Overview
Developing content for ASAM standards is focussed around the concept of xref:compendium:Guidelines/contribute_with_issues.adoc[contributing through issues].
...
. Begin submitting work via commits to the develop branch, adhering to the xref:compendium:tools/gitlab/repo__commit_conventions.adoc[**Commit Message Conventions**]
...
* Create branches xref:compendium:tools/gitlab/create_branch_from_issue.adoc[directly from the issue] to ensure the branch is linked to the issue.
...
* Squash commit message MUST adhere to the xref:compendium:tools/gitlab/repo__commit_conventions.adoc[**Commit Message Conventions**]
...
* Does it have a https://medium.com/@catalinaturlea/clean-git-history-a-step-by-step-guide-eefc0ad8696d[clear commit history^] that adheres to the xref:compendium:tools/gitlab/repo__commit_conventions.adoc[]?
