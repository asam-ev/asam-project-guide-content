...
TIP: If you are not setting up or responsible for a git repository, you only need to know how to xref:compendium:How-Tos/how-to__submodule_pull.adoc[pull a previously set up submodule in git].
