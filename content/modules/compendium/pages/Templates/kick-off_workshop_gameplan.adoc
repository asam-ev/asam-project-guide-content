...
Here, the project decides on its set of rules and guidelines, defines meeting intervals, elects the Project Lead and the Subgroup Leads, and starts to add more detail to the project planning.
//end::context[]
...
. Specify the (currently) relevant Subgroups
* Subgroups may change over the course of a project.
...
* Each Subgroup shall define their individual WG meetings intervals
