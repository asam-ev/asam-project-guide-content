...
== Workshop Goals
//tag::goals[]
The goals of Kick-off Workshop are:
...
. Plan the first cycle; alternatively, schedule the first xref:getting-involved:development/cycle_planning.adoc[Cycle Planning]
