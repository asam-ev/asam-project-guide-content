...
include::compendium:page$How-Tos/how-to-vscode_install_extension.adoc[{offset-value}]

include::compendium:page$Guidelines/vscode-recommended_vscode_extensions.adoc[{offset-value-sub}]

include::compendium:page$Guidelines/vscode-recommended_vscode_settings.adoc[{offset-value}]