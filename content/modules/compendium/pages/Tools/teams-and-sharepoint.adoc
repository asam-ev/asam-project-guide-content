...
|xref:compendium:Tools/teams_and_sharepoint/teams-and-sharepoint-setup.adoc[image:{setup-image}[width=120,title="Teams And Sharepoint Setup"]]
|Teams And Sharepoint Setup

|xref:compendium:Tools/teams_and_sharepoint/teams-and-sharepoint-guides.adoc[image:{guide-image}[width=120,title="Teams And Sharepoint Guides"]]
