...
|xref:compendium:Tools/sharepoint/sharepoint-setup.adoc[image:{setup-image}[width=120,title="Teams And Sharepoint Setup"]]
|Teams And Sharepoint Setup

|xref:compendium:Tools/sharepoint/sharepoint-guides.adoc[image:{guide-image}[width=120,title="Teams And Sharepoint Guides"]]
