...
image::compendium:snychronizing_with_onedrive.gif[Demo on synchronizing]include::compendium:page$How-Tos/synchronizing_sharepoint_with_onedrive.adoc[{offset_value}]
