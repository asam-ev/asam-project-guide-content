...
== Context
MS Sharepoint are used at ASAM to allow for communication (both through text and audio/video) within project teams and exchange files and documents without direct impact on the standardization processes.
...
== Prerequisites
* Access to MS Sharepoint has been granted by ASAM.
