...
[#sec-ASM-114]
== Use the modal verb _can_ or _cannot_ to express a possibility and capability (ASM-114)
...
[#sec-ASM-111]
== Use the modal verb _must_ to express an external constraint (ASM-111)
