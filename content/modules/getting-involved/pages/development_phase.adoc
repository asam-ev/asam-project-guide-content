...
image::compendium:asam/development_phase.drawio.svg[title="The development phase in detail, using the xref:concepts:diagram_notations.adoc[ASAM Project Phase Notation]"]
