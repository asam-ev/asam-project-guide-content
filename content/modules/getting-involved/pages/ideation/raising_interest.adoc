...
== What Happens Next?
Once all <<Requirements For Transitioning To Proposal Phase,requirements>> have been met, the project transitions to the xref:getting-involved:proposal_phase.adoc[proposal phase].
