...
== How
. The GTM prepares the workshop using the xref:compendium:ASAM/phase-01_ideation/ideation_workshop_gameplan.adoc[]
...
include::compendium:ASAM/phase-01_ideation/ideation_workshop_gameplan.adoc[tag=agenda_example]
