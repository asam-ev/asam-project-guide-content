...
// After the overall goals have been specified and communicated, the SG Leads specify the detailed goals for the respective involved Subgroups.
...
// Each work group will also meet regularly in its Subgroup Meetings. +
// Note that each work group may define the intervals and modalities of their meetings for themselves.

// To coordinate activities between different Subgroups, ASAM recommends that all SG Leads meet regularly during each cycle.
...
// Similarly to the Subgroup Meetings, each project may define their own intervals for CCB meetings.
