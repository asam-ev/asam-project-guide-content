...
h|Involved
| {role-wg-lead}, {role-wg-member}, {role-service-provider}, {role-technical-writer}
...
include::compendium:How-Tos/how-to-cycle_planning_project-level.adoc[tag=body, leveloffset=+1]

---

== Work-group-level Planning
include::compendium:How-Tos/how-to-cycle_planning_wg-level.adoc[tag=body, leveloffset=+1]
