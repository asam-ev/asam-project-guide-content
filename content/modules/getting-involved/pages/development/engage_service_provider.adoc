...
. The Service Providers and the subgroup negotiate terms and conditions
. The subgroup decides on a Service Provider
...
Talk to your GTM to figure out a solution.
