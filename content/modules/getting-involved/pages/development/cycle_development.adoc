...
h|Involved
| {role-sg-lead}, {role-project-lead}, {role-ccb}
...
During this period, each WG will schedule one or more xref:compendium:Guidelines/coordination-wg_meeting_guidelines.adoc[Sub-group Meetings]. +
Additionally, the Project Lead (and possibly the CCB) may meet with the SG Leads in one or more xref:compendium:Guidelines/coordination-sg-lead_meeting_guidelines.adoc[SG Lead Meetings]. +
