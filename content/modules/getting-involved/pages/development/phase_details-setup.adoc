...
The GTM takes the list of enrolled members, creates a new xref:compendium:Tools/teams-and-sharepoint.adoc[MS Teams] channel for the project (if it does not exist yet), creates a related Sharepoint folder, and adds all participants to that channel and folder. +
