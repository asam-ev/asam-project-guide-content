...
If the project has requested budget for one or more Service Providers, a xref:compendium:Terminology/call_for_offers.adoc[call for offer] is issued, potential Service Providers present their offers, and the project decides on whom to contract.
...
In case the project requested budget for support through Service Providers, the project must issue a xref:compendium:Terminology/call_for_offers.adoc[call for offer], review received offers, select one or more Service Providers, and introduce them to the project after the contracts have been signed. +
