...
If you are looking to join a scheduled webinar, see xref:getting-involved:tbd/join_webinar.adoc[] instead.
...
. Propose your webinar to your OR contact for support


NOTE: All optional steps will have to be carried out before the event in any case.
It is recommended to do them before approaching the OR contact to speed up the process.
