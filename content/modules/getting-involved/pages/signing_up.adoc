...
include::compendium:page$How-Tos/enroll_for_ideation.adoc[tag=body, leveloffset=+1]
...
include::compendium:page$How-Tos/enroll_for_development.adoc[tag=body, leveloffset=+1]
