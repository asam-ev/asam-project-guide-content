...
|===
a|include::compendium:page$How-Tos/enroll_for_ideation.adoc[tag=body, leveloffset=+1]
|===
...
[grid=none, frame=none]
|===
a|include::compendium:page$How-Tos/enroll_for_development.adoc[tag=body, leveloffset=+1]
|===
...
* xref:signing_up/become_sub-group_lead.adoc[Sub-group Lead]