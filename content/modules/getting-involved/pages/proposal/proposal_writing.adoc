...
Participation in the creation of a Project Proposal follows the central xref:compendium:Guidelines/workflow__trunk.adoc[**Trunk-based Workflow**] at ASAM.
...
When writing AsciiDoc, writers must follow the guidelines described in **xref:compendium:Guidelines/workflow__contribute_in_asciidoc.adoc[]** as well as the <<ASAM Editorial Guide>>.
...
// include::compendium:page$How-Tos/how-to__executive_draft.adoc[leveloffset=+1, tags=body]


== Writing The Proposal Draft

include::compendium:page$How-Tos/how-to__proposal_writing.adoc[leveloffset=+1, tags=body]
