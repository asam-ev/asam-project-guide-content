...
== How To Contribute
IMPORTANT: You must first complete the xref:contributing:working-without-software-installation.adoc#_minimum_required_setup[**Minimum Required Setup**] before you can participate in and contribute to any project. +
...
Both ways of contribution can be performed xref:contributing:working-without-software-installation.adoc[without software installation] directly through the respective web interface.
...
// include::compendium:page$How-Tos/how-to-executive_draft.adoc[leveloffset=+1, tags=body]


== Writing The Proposal Draft

include::compendium:page$How-Tos/how-to-proposal_writing.adoc[leveloffset=+1, tags=body]
