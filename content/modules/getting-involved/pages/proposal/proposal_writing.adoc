...
All committed participants (the Idea Giver, the Proposal Submitter, and all prospective Subgroup Members) can participate in writing the proposal document (the Proposal Submitter actually has to participate in the <<Finalizing the Proposal,finalization step>>). +
