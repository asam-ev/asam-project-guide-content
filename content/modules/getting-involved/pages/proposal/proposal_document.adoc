...
Click xref:proposal/proposal_writing.adoc[**here**] to learn more about how you can contribute to it directly.
...
* Actors
* Use Cases
* Features (mapped to one or more Use Cases)
* Work Packages with estimated effort (in t-shirt sizes)
* <<Commitments>>
* <<Project timeline>>
...
include::compendium:page$Guidelines/deliverables.adoc[leveloffset=+1, tag=body]

== Project structure
The proposal must specify the expected Sub-groups and their designated leads. +
...
== Project type
The proposal must specify the xref:concepts:project_types.adoc[type of project] it wants to start.