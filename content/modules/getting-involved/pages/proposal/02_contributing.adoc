...
When writing AsciiDoc, writers must follow the guidelines described in **xref:compendium:ASAM/doc-as-code/contribute_in_asciidoc.adoc[]** as well as the <<ASAM Editorial Guide>>.
...
The current version of the Editorial Guide is located in the xref:compendium:writing_guidelines/editorial_guide.adoc#_basics[**Project Guide Compendium**].
