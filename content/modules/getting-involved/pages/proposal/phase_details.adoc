...
For each named individual a clear resource commitment in the form of many days of effort being committed over the project's runtime is required -- see xref:signing_up.adoc[commitment requirements].
