...
>h|Involved
|{role-gtm}, {role-project-participant}
|===
...
>h|Involved
|{role-gtm} plus at least two {role-project-participant}, [role-tsc-member]
|===
...
// >h|Involved
// |{role-gtm} plus at least two {role-project-participant}
// |===
