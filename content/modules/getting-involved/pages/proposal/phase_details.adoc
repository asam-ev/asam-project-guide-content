...
An enrollment consists of one or more named inviduals that will actively contribute to the project's development. +
For each named individual a clear resource comittment in the form of many days of effort being comitted over the project's runtime is required- see xref:signing_up.adoc[comittment requirements].
