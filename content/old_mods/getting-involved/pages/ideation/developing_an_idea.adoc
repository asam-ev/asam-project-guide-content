...
h| TL;DR
a| * OR prepares the workshop and informs interested parties
...
== How
. The OR prepares the workshop using the xref:compendium:Templates/ideation_workshop_gameplan.adoc[]
. The OR informs people who have already signed up to the ideation workshop
* Optionally, the OR broadly informs all ASAM members if this approach seems necessary
...
. The OR creates a protocol of the event and sends it to all people who had signed up
