...
Other external roles, such as xref:role-specific:office-responsible.adoc[] or xref:role-specific:service-provider.adoc[], may support during the current project phase.
