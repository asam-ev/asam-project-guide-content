= Polls & surveys with Microsoft Teams
:description: Use polls and surveys with MS Teams
:keywords: teams,email,surveys
...
Microsoft Teams offers a tool called "Polly" which is directly integrated and can be used within a Teams channel.
