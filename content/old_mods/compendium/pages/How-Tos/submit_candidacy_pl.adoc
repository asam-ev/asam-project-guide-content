= Submit candidacy for Project Lead
...
|===
h|Responsible
|{role-project-participant} -> {role-project-lead}
...
h|TL;DR
a| * Send an email to your OR containing your candidacy for Project Lead
...
== How
* Send an email to your OR with your candidacy for the role of Project Lead
