...
|xref:compendium:Tools/teams_and_sharepoint/teams_and_sharepoint-setup.adoc[image:{setup-image}[width=120,title="Teams And Sharepoint Setup"]]
|Teams And Sharepoint Setup

|xref:compendium:Tools/teams_and_sharepoint/teams_and_sharepoint-guides.adoc[image:{guide-image}[width=120,title="Teams And Sharepoint Guides"]]
