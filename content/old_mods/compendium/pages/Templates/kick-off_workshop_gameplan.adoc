...
Here, the project decides on its set of rules and guidelines, defines meeting intervals, elects the Project Lead and the Sub-group Leads, and starts to add more detail to the project planning.
//end::context[]
...
. Specify the (currently) relevant Sub-groups
* Sub-groups may change over the course of a project.
The workshop shall define the setup with which it wants to start into the development
. Elect Sub-group Leads
* The SG Leads and the Project Lead shall define their SG Leads meetings interval
...
* Each Sub-group shall define their individual WG meetings intervals
