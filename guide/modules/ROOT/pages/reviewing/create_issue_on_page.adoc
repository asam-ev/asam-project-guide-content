...
:keywords: gitlab, review, project-guide, service-desk
...
== How
// include::latest@asamprojectguide:compendium:partial$How-Tos/how-to__create_issue_service_desk.adoc[tag=steps]

. Click btn:[Submit feedback]
+
image::latest@asamprojectguide:compendium:submit_feedback_button.png[title='"Submit feedback" button in Antora project', role="thumb"]
. Edit the title of the form
. Select the relevant topics by replacing any `- [ ]` with `- [x]` in the "Prerequisites" section
. Add a title of the topic to the section "Summary"
...
+
image::latest@asamprojectguide:compendium:submit_form_github.png[title="The issue form for submitting feedback in GitHub"]
. Click btn:[Submit new issue]
