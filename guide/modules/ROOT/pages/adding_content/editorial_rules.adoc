...
Sub-group members and Technical Writers shall apply the rules when creating documentation for ASAM.
This section contains information on how to create and apply editorial rules.

== Using editorial rules

. Provide the ASAM Editorial Guide to sub-group members and technical writers when a project starts.
. sub-group members should try to apply the editorial rules.
. Technical writers may educate sub-group members who do not apply the editorial rules.
. Technical writers shall review the content committed by sub-group members as soon as possible.
...
.. Check if an editorial rule exists in the https://asd-ste100.org/request.html[ASD-STE100 Specification] (ASD Simplified Technical English, ASD-STE100, is a Copyright and a Trade Mark of ASD, Brussels, Belgium).
