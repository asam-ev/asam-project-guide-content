...
See the xref:compendium:Guidelines/editorial_guide.adoc[] for detailed requirements on each anchor type.

//end::how[]

//tag::prerequisits[]
* All relevant figures must have an xref:compendium:Guidelines/editorial_guide.adoc[ASAM-type anchor]
* All relevant tables must have an xref:compendium:Guidelines/editorial_guide.adoc[ASAM-type anchor]
